...
<style>
    ...
    margin-bottom: 20px; /* Margin at the bottom of paragraphs */
    }
    .yellow-text {
  color: yellow;
}
...
<body>
    <div id="container">
        ...
        <header>
            ...
            <nav>
                <ul id='menu'>
                    ...
                    <li class="active"> <a href="#"> <i class="fas fa-phone-square-alt"></i> Contact </a></li>
                </ul>
            </nav>
        ...
        <main>
            ...
            <!-- @TODO #3 : Style the contact form-->
           

            <section id="contact-form">
          
                Contact details
                Address: 399 Main Street, Cityville
                ...
                <!--@TODO: Put a map with the location of the company-->
                ...
                <form name="contactForm"  method="POST" action="process.php">
                    ...
                    <div>
                        ...
                        <select class="form-select" id="pcode" name="pcode" required>
                        ...
                        <input type="pnumber" name="pnumber" id="pnumber" required>
