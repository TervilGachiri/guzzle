...
if (isset($_POST['submit']) && $_POST['submit'] == "submit") {
   ...
   //2.Validation
   //make sure that the format of what we expect is cadhered to
   //for example, a name should be a name i.e.there are no names that start with numbers
...
//die();
     ...
     // $string1 = "Ng\"ang\"a";
      ...
      echo "Invalid name provided :<button onclick='history.back()'>Go  Back to contact Page</button>";
      die();
   }
} else {
