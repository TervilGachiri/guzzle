...
abstract class Contact implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Models\\Map\\ContactTableMap';
    ...
    /**
     * Initializes internal state of Models\Base\Contact object.
     */
    ...
    /**
     * Get the [optionally formatted] temporal [contact_date] column value.
     *
     *
     ...
     */
    public function getContactDate($format = null)
    {
        if ($format === null) {
            return $this->contact_date;
        } else {
            return $this->contact_date instanceof \DateTimeInterface ? $this->contact_date->format($format) : null;
        }
    }
    ...
    public function setCountry($v)
    {
        ...
        if ($this->country !== $v) {
            $this->country = $v;
            $this->modifiedColumns[ContactTableMap::COL_COUNTRY] = true;
        }
    ...
    /**
     * Sets the value of [contact_date] column to a normalized version of the date/time value specified.
     *
    ...
    public function setContactDate($v)
    {
        ...
        if ($this->contact_date !== null || $dt !== null) {
            if ($this->contact_date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->contact_date->format("Y-m-d H:i:s.u")) {
                $this->contact_date = $dt === null ? null : clone $dt;
                $this->modifiedColumns[ContactTableMap::COL_CONTACT_DATE] = true;
            }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ContactTableMap::translateFieldName('Email', TableMap::TYPE_PHPNAME, $indexType)];
            $this->email = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ContactTableMap::translateFieldName('Country', TableMap::TYPE_PHPNAME, $indexType)];
            $this->country = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ContactTableMap::translateFieldName('ContactDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->contact_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ContactTableMap::translateFieldName('Message', TableMap::TYPE_PHPNAME, $indexType)];
            $this->message = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ContactTableMap::translateFieldName('Phone', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Models\\Contact'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(ContactTableMap::COL_COUNTRY)) {
            $modifiedColumns[':p' . $index++]  = 'country';
        }
        if ($this->isColumnModified(ContactTableMap::COL_CONTACT_DATE)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'country':
                        ...
                        break;
                    case 'contact_date':
                        $stmt->bindValue($identifier, $this->contact_date ? $this->contact_date->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) {
            $this->setContactDate($arr[$keys[4]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(ContactTableMap::COL_COUNTRY)) {
            $criteria->add(ContactTableMap::COL_COUNTRY, $this->country);
        }
        if ($this->isColumnModified(ContactTableMap::COL_CONTACT_DATE)) {
            $criteria->add(ContactTableMap::COL_CONTACT_DATE, $this->contact_date);
        }
        if ($this->isColumnModified(ContactTableMap::COL_MESSAGE)) {
     ...
     * objects.
     *
     * @param object $copyObj An object of \Models\Contact (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Models\Contact Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
